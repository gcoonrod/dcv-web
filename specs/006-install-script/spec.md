...
- A SHA-256 checksum file and a corresponding cryptographic signature file will be published alongside each release binary. The signing mechanism (e.g., GPG detached signature, minisign) will be finalized during planning based on what the dcv build pipeline produces.
